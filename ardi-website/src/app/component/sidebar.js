        ...
        <div class="sidebar min-h-screen w-[3.35rem] overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
            ...
            <div>
                ...
                <li class="min-w-max">
                    ...
                    <span class="group-hover:text-gray-700">Service</span>
                    </a>
                </li>
                <li class="min-w-max">
                    ...
                    <span class="group-hover:text-gray-700">Projects</span>
                    </a>
                </li>
                <li class="min-w-max">
                    <a href="#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
            ...
            <div class="w-max -mb-3">
                ...
                <span class="group-hover:text-gray-700">Mohammad Ardi Iradat</span>
                </a>
            </div>
            </div>
        </div>
